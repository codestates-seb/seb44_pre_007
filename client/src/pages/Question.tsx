  ...
  return (
    <main className="w-[1051px]">
      <div className="flex justify-between items-start mb-3">
        {!!data && <h1 className="mr-3 mb-3 text-[27px] text-blackDark">{data.question_title}</h1>}
      ...
      <div className="flex gap-4 pb-2 mb-4 border-b border-brgray">
        {!!data && (
          <>
            ...
            <div className="text-blacklight text-[13px] pb-2">Modified {data.question_updated}</div>
          </>
        )}
      </div>
